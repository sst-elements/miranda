...
class Stencil3DBenchGenerator : public RequestGenerator {
  ...
  public:
    ...
    SST_ELI_DOCUMENT_PARAMS(
        ...
        {"startz",
         "Sets the start location in Z-plane for this instance, parallelism implemented as Z-plane decomposition", "0"},
        {"endz", "Sets the end location in Z-plane for this instance, parallelism implemented as Z-plane decomposition",
         "10"},
