...
class InOrderSTREAMBenchGenerator : public RequestGenerator {
   public:
    ...
    InOrderSTREAMBenchGenerator(ComponentId_t id, Params &params) : RequestGenerator(id, params) {
        build(params);
    }
    ...
    void generate(MirandaRequestQueue<GeneratorRequest *> *q) override {
        ...
        auto b_reads =
            static_cast<MemoryOpRequest **>(malloc(sizeof(MemoryOpRequest *) * block_per_call));
        auto c_reads =
            static_cast<MemoryOpRequest **>(malloc(sizeof(MemoryOpRequest *) * block_per_call));
        auto a_writes =
            static_cast<MemoryOpRequest **>(malloc(sizeof(MemoryOpRequest *) * block_per_call));
    ...
    auto isFinished() -> bool override { return i == n; }

    void completed() override {}

    SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(
        InOrderSTREAMBenchGenerator, "miranda", "InOrderSTREAMBenchGenerator",
