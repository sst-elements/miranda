...
class STREAMBenchGenerator_CustomCmd : public RequestGenerator {
  ...
  public:
    ...
    SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(
        STREAMBenchGenerator_CustomCmd, "miranda", "STREAMBenchGeneratorCustomCmd", SST_ELI_ELEMENT_VERSION(1, 0, 0),
        "Creates a representation of the STREAM benchmark using custom memory commands", SST::Miranda::RequestGenerator)
