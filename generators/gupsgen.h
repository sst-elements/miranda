...
class GUPSGenerator : public RequestGenerator {
   public:
    ...
    SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(
        GUPSGenerator, "miranda", "GUPSGenerator", SST_ELI_ELEMENT_VERSION(1, 0, 0),
        "Creates a random stream of accesses to read-modify-write", SST::Miranda::RequestGenerator)
    ...
    SST_ELI_DOCUMENT_PARAMS({"verbose", "Sets the verbosity output of the generator", "0"},
                            ...
                            {"max_address", "Maximum address allowed for generation",
                             "536870912" /* 512MB */},
                            {"issue_op_fences",
